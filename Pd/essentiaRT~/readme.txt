...
essentiaRT~ is a real-time implementation of Essentia (MTG's open-source C++ library for audio analysis and audio-based music information retrieval) as Pd and Max/MSP objects. As such, it does not yet include all of Essentia’s algorithms, but a number of feature extractors considered useful in a real-time scenario to slice and provide on-the-fly classification audio.
